...
조건: 교착상태는 아래의 조건을 모두 만족하는 것과 동일함.
...
* 중기 스케쥴러: 페이지 교체를 결정함.
* 단기 스케쥴러: ready queue에서 CPU에 할당될 프로세스를 결정함.
...
* Inboard Memory: 레지스터, 캐시, 메인 메모리
* Outboard Memory: 보조기억장치
* Off-line Storage: 사람에 의해 연결/제거가 가능한 보조기억장치, Flash Drive, 광학 디스크
